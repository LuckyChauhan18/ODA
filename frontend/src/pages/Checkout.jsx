...
const stateDistricts = {
  ...
  'Arunachal Pradesh': ['Tawang', 'West Kameng', 'East Kameng', 'Papum Pare', 'Kurung Kumey', 'Lower Subansiri', 'Upper Subansiri', 'West Siang', 'East Siang', 'Siang', 'Upper Siang', 'Lower Siang', 'Lower Dibang Valley', 'Upper Dibang Valley', 'Anjaw', 'Lohit', 'Namsai', 'Changlang', 'Tirap', 'Longding'],
  ...
  'Bihar': ['Patna', 'Gaya', 'Bhagalpur', 'Muzaffarpur', 'Darbhanga', 'Nalanda', 'Saran', 'Vaishali', 'Araria', 'Aurangabad', 'Banka', 'Begusarai', 'Bhojpur', 'Buxar', 'Gopalganj', 'Jamui', 'Jehanabad', 'Katihar', 'Khagaria', 'Kishanganj', 'Lakhisarai', 'Madhepura', 'Madhubani', 'Munger', 'Nawada', 'Purnia', 'Rohtas', 'Saharsa', 'Samastipur', 'Sheikhpura', 'Sheohar', 'Sitamarhi', 'Siwan', 'Supaul'],
  'Chhattisgarh': ['Raipur', 'Bilaspur', 'Durg', 'Rajnandgaon', 'Korba', 'Raigarh', 'Bastar', 'Janjgir-Champa', 'Kabirdham', 'Kanker', 'Mahasamund', 'Dantewada', 'Surguja', 'Jashpur', 'Dhamtari'],
  'Goa': ['North Goa', 'South Goa'],
  'Gujarat': ['Ahmedabad', 'Surat', 'Vadodara', 'Rajkot', 'Bhavnagar', 'Jamnagar', 'Gandhinagar', 'Junagadh', 'Anand', 'Bharuch', 'Kheda', 'Mehsana', 'Morbi', 'Navsari', 'Panchmahal', 'Patan', 'Porbandar', 'Sabarkantha', 'Valsad', 'Amreli', 'Banaskantha', 'Dahod', 'Kutch', 'Surendranagar'],
  'Haryana': ['Gurugram', 'Faridabad', 'Panipat', 'Ambala', 'Rohtak', 'Hisar', 'Karnal', 'Sonipat', 'Panchkula', 'Yamunanagar', 'Kurukshetra', 'Bhiwani', 'Fatehabad', 'Jhajjar', 'Jind', 'Kaithal', 'Mahendragarh', 'Palwal', 'Rewari', 'Sirsa'],
  'Himachal Pradesh': ['Shimla', 'Kangra', 'Mandi', 'Solan', 'Una', 'Chamba', 'Hamirpur', 'Kullu', 'Sirmaur', 'Bilaspur', 'Kinnaur', 'Lahaul and Spiti'],
  'Jharkhand': ['Ranchi', 'Jamshedpur', 'Dhanbad', 'Bokaro', 'Hazaribagh', 'Deoghar', 'Dumka', 'Giridih', 'Chaibasa', 'Garhwa', 'Gumla', 'Koderma', 'Latehar', 'Lohardaga', 'Pakur', 'Palamu', 'Ramgarh', 'Sahibganj'],
  'Karnataka': ['Bengaluru Urban', 'Bengaluru Rural', 'Mysuru', 'Hubballi-Dharwad', 'Mangaluru', 'Belagavi', 'Davangere', 'Ballari', 'Vijayapura', 'Kalaburagi', 'Shivamogga', 'Tumakuru', 'Udupi', 'Uttara Kannada', 'Bagalkot', 'Bidar', 'Chamarajanagar', 'Chikballapur', 'Chikkamagaluru', 'Chitradurga', 'Hassan', 'Haveri', 'Kodagu', 'Kolar', 'Koppal', 'Mandya', 'Raichur', 'Ramanagara', 'Yadgir'],
  'Kerala': ['Thiruvananthapuram', 'Kochi', 'Kozhikode', 'Thrissur', 'Kollam', 'Alappuzha', 'Palakkad', 'Malappuram', 'Kannur', 'Kottayam', 'Kasaragod', 'Idukki', 'Pathanamthitta', 'Wayanad'],
  'Madhya Pradesh': ['Indore', 'Bhopal', 'Jabalpur', 'Gwalior', 'Ujjain', 'Sagar', 'Satna', 'Rewa', 'Dewas', 'Ratlam', 'Singrauli', 'Murwara', 'Chhindwara', 'Khandwa', 'Bhinder', 'Hoshangabad', 'Vidisha', 'Shivpuri', 'Damoh'],
  'Maharashtra': ['Mumbai City', 'Mumbai Suburban', 'Pune', 'Nagpur', 'Thane', 'Nashik', 'Aurangabad', 'Solapur', 'Amravati', 'Navi Mumbai', 'Kolhapur', 'Akola', 'Jalgaon', 'Latur', 'Nanded', 'Sangli', 'Satara', 'Chandrapur', 'Dhule', 'Ahmednagar', 'Beed', 'Buldhana', 'Gondia', 'Jalna', 'Osmanabad', 'Parbhani', 'Raigad', 'Ratnagiri', 'Wardha', 'Washim', 'Yavatmal'],
  'Manipur': ['Imphal East', 'Imphal West', 'Bishnupur', 'Thoubal', 'Churachandpur', 'Senapati', 'Ukhrul', 'Chandel', 'Tamenglong'],
  'Meghalaya': ['East Khasi Hills', 'West Garo Hills', 'West Jaintia Hills', 'Ri Bhoi', 'West Khasi Hills', 'East Jaintia Hills', 'South Garo Hills'],
  'Mizoram': ['Aizawl', 'Lunglei', 'Champhai', 'Kolasib', 'Serchhip', 'Mamit', 'Lawngtlai', 'Saiha'],
  'Nagaland': ['Kohima', 'Dimapur', 'Mokokchung', 'Tuensang', 'Wokha', 'Zunheboto', 'Phek', 'Mon'],
  'Odisha': ['Bhubaneswar', 'Cuttack', 'Rourkela', 'Brahmapur', 'Sambalpur', 'Puri', 'Balasore', 'Bhadrak', 'Baripada', 'Jharsuguda', 'Bargarh', 'Rayagada', 'Koraput', 'Angul', 'Dhenkanal'],
  'Punjab': ['Ludhiana', 'Amritsar', 'Jalandhar', 'Patiala', 'Bathinda', 'Mohali', 'Hoshiarpur', 'Pathankot', 'Moga', 'Phagwara', 'Abohar', 'Ferozepur', 'Khanna', 'Muktsar', 'Barnala', 'Faridkot', 'Gurdaspur', 'Kapurthala', 'Sangrur'],
  'Rajasthan': ['Jaipur', 'Jodhpur', 'Kota', 'Bikaner', 'Ajmer', 'Udaipur', 'Bhilwara', 'Alwar', 'Sikar', 'Sri Ganganagar', 'Bharatpur', 'Hanumangarh', 'Churu', 'Pali', 'Barmer', 'Jaisalmer', 'Jhunjhunu', 'Jhalawar', 'Tonk', 'Sawai Madhopur'],
  'Sikkim': ['East Sikkim', 'West Sikkim', 'South Sikkim', 'North Sikkim'],
  'Tamil Nadu': ['Chennai', 'Coimbatore', 'Madurai', 'Tiruchirappalli', 'Salem', 'Tiruppur', 'Erode', 'Vellore', 'Thanjavur', 'Thoothukudi', 'Nagercoil', 'Dindigul', 'Cuddalore', 'Kanchipuram', 'Tiruvannamalai', 'Krishnagiri', 'Karur', 'Namakkal'],
  'Telangana': ['Hyderabad', 'Warangal', 'Nizamabad', 'Karimnagar', 'Khammam', 'Ramagundam', 'Mahabubnagar', 'Nalgonda', 'Adilabad', 'Suryapet', 'Miryalaguda', 'Jagtial'],
  'Tripura': ['West Tripura', 'South Tripura', 'North Tripura', 'Dhalai', 'Unakoti', 'Gomati', 'Khowai'],
  'Uttarakhand': ['Dehradun', 'Haridwar', 'Haldwani', 'Rudrapur', 'Roorkee', 'Kashipur', 'Rishikesh', 'Nainital', 'Almora', 'Pithoragarh', 'Mussoorie'],
  'Uttar Pradesh': ['Agra', 'Aligarh', 'Allahabad', 'Ambedkar Nagar', 'Amethi', 'Amroha', 'Auraiya', 'Azamgarh', 'Baghpat', 'Bahraich', 'Ballia', 'Balrampur', 'Banda', 'Barabanki', 'Bareilly', 'Basti', 'Bhadohi', 'Bijnor', 'Budaun', 'Buldhabshar', 'Chandauli', 'Chitrakoot', 'Deoria', 'Etah', 'Etawah', 'Faizabad', 'Farrukhabad', 'Fatehpur', 'Firozabad', 'Gautam Buddha Nagar (Noida)', 'Ghaziabad', 'Ghazipur', 'Gonda', 'Gorakhpur', 'Hamirpur', 'Hapur', 'Hardoi', 'Hathras', 'Jalaun', 'Jaunpur', 'Jhansi', 'Kannauj', 'Kanpur Dehat', 'Kanpur Nagar', 'Kasganj', 'Kaushambi', 'Kheri', 'Kushinagar', 'Lalitpur', 'Lucknow', 'Maharajganj', 'Mahoba', 'Mainpuri', 'Mathura', 'Mau', 'Meerut', 'Mirzapur', 'Moradabad', 'Muzaffarnagar', 'Pilibhit', 'Pratapgarh', 'Rae Bareli', 'Rampur', 'Saharanpur', 'Sambhal', 'Sant Kabir Nagar', 'Shahjahanpur', 'Shamli', 'Shravasti', 'Siddharthnagar', 'Sitapur', 'Sonbhadra', 'Sultanpur', 'Unnao', 'Varanasi'],
  'West Bengal': ['Kolkata', 'Howrah', 'Darjeeling', 'Siliguri', 'Asansol', 'Durgapur', 'Kharagpur', 'Bardhaman', 'Malda', 'Baharampur', 'Jalpaiguri', 'Haldia', 'Shantipur', 'Balurghat', 'Habra', 'Ranaghat'],
  'Andaman and Nicobar Islands': ['South Andaman', 'North and Middle Andaman', 'Nicobar'],
  'Chandigarh': ['Chandigarh'],
  'Dadra and Nagar Haveli and Daman and Diu': ['Dadra and Nagar Haveli', 'Daman', 'Diu'],
  'Delhi': ['New Delhi', 'Central Delhi', 'East Delhi', 'North Delhi', 'South Delhi', 'West Delhi', 'North West Delhi', 'South West Delhi'],
  'Jammu and Kashmir': ['Srinagar', 'Jammu', 'Anantnag', 'Baramulla', 'Kathua', 'Pulwama', 'Kupwara', 'Samba', 'Poonch', 'Rajouri', 'Udhampur'],
  'Ladakh': ['Leh', 'Kargil'],
  'Lakshadweep': ['Kavaratti'],
  'Puducherry': ['Puducherry', 'Karaikal', 'Mahe', 'Yanam']
};

const indianStates = Object.keys(stateDistricts);
